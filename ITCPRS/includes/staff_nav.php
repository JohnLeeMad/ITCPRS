...
/**
 * includes/staff_nav.php
 * ─────────────────────────────────────────────────────────────
 * Shared sidebar + topbar for Staff (Mekaniko) pages.
 *
 * HOW TO USE — at the top of every staff page:
 * ─────────────────────────────────────────────
 *   <?php
...
$page_title  = $page_title  ?? 'Staff Panel';

// ─────────────────────────────────────────────────────────────
//  NAV MENU — Staff (Mekaniko): Dashboard, Inventory, Parts Requests, Profile
// ─────────────────────────────────────────────────────────────
$nav_items = [
  'dashboard' => [
    'label' => 'Dashboard',
    'href'  => '/modules/dashboard/staff.php',
...
$nav_sections = [
  'Main'    => ['dashboard', 'inventory', 'parts'],
];
?>
<!DOCTYPE html>
<html lang="en">
...
════════════════════════════════════════ -->
  <header class="topbar" id="topbar">
    ...
    <div class="topbar-title">
      <span class="topbar-breadcrumb">Staff</span>
